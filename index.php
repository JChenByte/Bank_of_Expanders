...
$url = 'https://daemon17.jchenbyte.com/api.php/accountinfo/588d4d601756fc834d903dc6';
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          <a href="https://daemon17.jchenbyte.com/home.php">
            <i  class="fa fa-bank"></i> <span >Home</span>
          </a>
        </li><li class="treeview">
          <a href="https://daemon17.jchenbyte.com/activity.html#">
            <i class="fa fa-align-left"></i>
            <span >Activity Detail</span>
          </a>
        </li>
        <li class="treeview">
          <a href="https://daemon17.jchenbyte.com/branch.html">
            <i  class="fa fa-globe"></i> <span >Branch</span>
          </a>
        </li>
        <li class="treeview">
          <a href="https://daemon17.jchenbyte.com/atm.html#">
            <i class="fa fa-money"></i>
            <span >ATM</span>
          </a>
        </li>
        <li  class="treeview ">
          <a  href="https://daemon17.jchenbyte.com/deposit.html#">
            <i class="fa fa-dollar active"></i>
            <span  >Deposit</span>
          </a>
        </li>
        <li class="treeview">
          <a href="https://daemon17.jchenbyte.com/withdraw.html#">
            <i class="fa fa-credit-card"></i>
            <span>Withdraw</span>
          </a>
        </li>
        <li class="treeview">
          <a href="https://daemon17.jchenbyte.com/stock.html#">
            <i class="fa fa-bar-chart"></i> <span >Stocks</span>
          </a>
        </li>
        <li class="treeview">
          <a href="https://daemon17.jchenbyte.com/cscore.html#">
